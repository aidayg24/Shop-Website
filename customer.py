...
class Customer: #Define the customer class to organize the client's tasks and authority
    ...
    #A window will open for the customer to enter the product and brand name and the number she wants to make a purchase
        ...
        btn_admin = Button(taskbar_frame, text='Admin', bg='firebrick4', command=admin.login).grid(row=0, column=0,sticky="ew", padx=5,pady=5)
        btn_bsktet = Button(taskbar_frame, text='basket', bg='VioletRed4',command=self.showbasket).grid(row=2, column=0, sticky="ew", padx=5,pady=5)
        btn_exit = Button(taskbar_frame, text="Exit", bg='red4', command=addtobaskt.quit).grid(row=10, column=0, sticky="ew",padx=5)
    ...
    #A window will open to display the customer invoice as a table and finalize it if desired
        ...
        btn_admin = Button(taskbar_frame, text='Admin', bg='firebrick4', command=admin.login).grid(row=0, column=0,sticky="ew", padx=5,pady=5)
        btn_cart = Button(taskbar_frame, text='basket', bg='VioletRed4',command=self.showbasket).grid(row=2, column=0, sticky="ew", padx=5,pady=5)
        btn_exit = Button(taskbar_frame, text="Exit", bg='red4', command=baskett.quit).grid(row=10, column=0, sticky="ew",padx=5)
        taskbar_frame.grid(row=0, column=0, sticky="ns")
